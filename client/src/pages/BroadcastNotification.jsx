...
const BroadcastNotification = () => {
  ...
  return (
    <div className="max-w-8xl mx-auto p-6 rounded-2xl bg-gradient-to-br from-gray-900 to-gray-800 border border-gray-700 shadow-2xl">
      <div className="flex items-center justify-between mb-6">
        <h2 className="text-2xl font-bold text-white flex items-center gap-3">
          <FiSend className="text-blue-400 w-6 h-6" />
      ...
      {isExpanded && (
        <div className="mb-6 p-4 bg-gray-800/50 border border-gray-700 rounded-xl relative">
          <button 
          ...
          <h3 className="font-semibold text-blue-400 mb-2">About Broadcasts</h3>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-5">
            <div>
              ...
              <input
                ...
                value={formData.link}
                onChange={handleChange}
                className="w-full px-4 py-2.5 border border-gray-700 rounded-xl bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
        ...
        <div>
          ...
          <textarea
            ...
            onChange={handleChange}
            rows={4}
            className="w-full px-4 py-3 border border-gray-700 rounded-xl bg-gray-800 text-white focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
          ...
          <div className="mt-2 flex justify-between text-xs">
            ...
            <span className={`${formData.message.length > 250 ? 'text-amber-500' : 'text-gray-500'}`}>
        ...
        <div className="mt-6 space-y-4">
          {broadcastStatus === 'success' && (
            <div className="p-4 flex items-start gap-3 bg-green-900/30 border border-green-800 rounded-xl animate-fadeIn">
              <FiCheckCircle className="text-green-400 mt-0.5 flex-shrink-0 w-5 h-5" />
              <div className="flex-1">
                <p className="font-semibold text-green-300">Broadcast Successful!</p>
          ...
          {broadcastStatus === 'error' && error && (
            <div className="p-4 flex items-start gap-3 bg-red-900/30 border border-red-800 rounded-xl animate-fadeIn">
              <FiAlertCircle className="text-red-400 mt-0.5 flex-shrink-0 w-5 h-5" />
              <div className="flex-1">
                <p className="font-semibold text-red-300">Broadcast Failed</p>
